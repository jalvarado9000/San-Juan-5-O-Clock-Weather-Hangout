    ...
    .then(data => {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            if (tempertureAtFive < rainy) {
                ...
                iconRow.src = `../photos/${weatherConditions[selectWeather].toLowerCase()}-weather.png`;
                ...
                selectWeather = 2;
                conditionRow.textContent = weatherConditions[selectWeather];
                iconRow.src = `../photos/${weatherConditions[selectWeather].toLowerCase()}-weather.jpg`;
            }

            

            //Writes day of the wee on html
